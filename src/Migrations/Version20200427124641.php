 ...
 */
final class Version20200427124641 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE etudiant (id INT NOT NULL, encadrant_id INT DEFAULT NULL, formation_id INT NOT NULL, date_naissance DATE NOT NULL, sexe INT NOT NULL, ville VARCHAR(255) NOT NULL, INDEX IDX_717E22E3FEF1BA4 (encadrant_id), INDEX IDX_717E22E35200282E (formation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
